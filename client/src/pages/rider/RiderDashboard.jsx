...
//       fetchRequests(); // re-fetch to get full populated data
//     });
...
//     try {
//       const { data } = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/delivery/my-requests`, {
//         headers:{
...
//         async ({ coords }) => {
//           try {
//             await axios.patch(`${import.meta.env.VITE_BACKEND_URL}/api/delivery/${requestId}/location`, {
//               lat: coords.latitude,
...
//     );
//     // Auto-start location sharing when rider accepts
...
//                 className="flex items-center gap-2 bg-green-100 text-green-700 text-sm font-semibold px-3 py-2 rounded-full"
//               >
...
//                 <div>
//                   <p className="text-sm font-semibold text-amber-800">Location sharing is off</p>
//                   <p className="text-xs text-amber-600 mt-0.5">
//                     The buyer and seller can't track you. Enable it for your active delivery.
//                   </p>
//                   <button
...
//                 <p className="text-sm text-gray-400 mt-1">Sellers will send delivery requests here</p>
//               </div>
//             ) : null}
