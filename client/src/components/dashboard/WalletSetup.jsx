...
// import { Wallet, CheckCircle, Loader2, Eye, EyeOff, ArrowUpRight, ArrowDownLeft, Send, Download, TrendingUp } from 'lucide-react';
...
//         setTransactions([
//           { id: 1, type: 'credit', amount: 45000, description: 'Delivery Fee - Order #ORD-7842', date: 'Today' },
//           { id: 2, type: 'debit', amount: 12500, description: 'Withdrawal to Wema Bank', date: 'Yesterday' },
//           { id: 3, type: 'credit', amount: 32000, description: 'Delivery Fee - Order #ORD-7831', date: '2 days ago' },
//         ]);
//       }
//     } catch (err) {
//       console.error(err);
//       toast.error("Failed to load wallet status");
//     } finally {
//       setLoading(false);
//     }
//   };
...
//     setCreating(true);
//     try {
//       await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/auth/create`, {}, {
//         headers: { Authorization: `Bearer ${token}` }
//       });

//       toast.success("🎉 Wallet created successfully!");
//       fetchWalletStatus(); // Refresh UI
//     } catch (error) {
...
//   if (loading) {
//     return <div className="flex justify-center items-center min-h-[70vh]"><Loader2 className="animate-spin w-10 h-10 text-emerald-600" /></div>;
//   }
...
//                 <p className="text-emerald-600 text-sm">Wema Bank • Active</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
//             <p className="text-emerald-100 tracking-widest text-sm">AVAILABLE BALANCE</p>
//             <div className="flex items-center gap-4 mt-3">
//               <p className="text-5xl font-bold tracking-tighter">
//                 {showBalance ? `₦${walletData.balance?.toLocaleString() || '0'}` : '•••••••'}
//               </p>
...
//               <button className="bg-white/20 py-4 rounded-2xl font-medium hover:bg-white/30 transition">Send</button>
//               <button className="bg-white/20 py-4 rounded-2xl font-medium hover:bg-white/30 transition">Receive</button>
//               <button className="bg-white/20 py-4 rounded-2xl font-medium hover:bg-white/30 transition">Withdraw</button>
//             </div>
//           </div>
...
//               Earnings Trend <TrendingUp className="text-emerald-600" />
//             </h3>
//             <div className="h-72">
//               <ResponsiveContainer width="100%" height="100%">
//                 <LineChart data={[
//                   { day: 'Mon', amount: 12500 }, { day: 'Tue', amount: 9800 },
//                   { day: 'Wed', amount: 15600 }, { day: 'Thu', amount: 8700 },
...
//                   <Line type="natural" dataKey="amount" stroke="#10b981" strokeWidth={4} />
//                 </LineChart>
//               </ResponsiveContainer>
//             </div>
//           </div>
...
//               {transactions.map(tx => (
//                 <div key={tx.id} className="flex justify-between items-center py-4 border-b last:border-0">
//                   <div className="flex items-center gap-4">
//                     <div className={`w-10 h-10 rounded-2xl flex items-center justify-center ${tx.type === 'credit' ? 'bg-emerald-100 text-emerald-600' : 'bg-red-100 text-red-600'}`}>
...
//         <div className="w-24 h-24 mx-auto bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl flex items-center justify-center text-6xl mb-8">
//           💳
//         </div>

//         <h1 className="text-3xl font-bold text-gray-900 mb-3">Create Your Wallet</h1>
//         <p className="text-gray-600 mb-8">Receive your earnings directly into your bank account</p>

//         {user && (
//           <div className="bg-gray-50 rounded-2xl p-6 mb-8 text-left">
//             <p className="text-sm text-gray-500">Creating wallet for:</p>
...
//           disabled={creating}
//           className="w-full py-5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white rounded-2xl font-semibold text-lg transition-all disabled:opacity-70 flex items-center justify-center gap-3"
//         >
//           {creating ? (
//             <>Creating Wallet...</>
//           ) : (
//             <>Create Wema Bank Wallet</>
//           )}
//         </button>

//         <p className="text-xs text-gray-500 mt-6">Default Password: <span className="font-mono bg-gray-100 px-2 py-0.5 rounded">password123</span></p>
//       </div>
//     </div>
//   );
// };
...
// // Replace direct WALLET_BASE calls in frontend with:
// await axios.post(`${API}/api/wallet/transfer`,        payload, { headers: authHdr() });
// await axios.post(`${API}/api/wallet/withdraw`,        payload, { headers: authHdr() });
// await axios.post(`${API}/api/wallet/verify-account`,  payload, { headers: authHdr() });
// await axios.get (`${API}/api/wallet/banks`,                    { headers: authHdr() });
// await axios.get (`${API}/api/wallet/balance`,                  { headers: authHdr() });
// await axios.post(`${API}/api/wallet/external-history`, {},     { headers: authHdr() });