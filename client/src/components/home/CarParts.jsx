...
//              car spare parts, car accessories, car electronics, motor oils, tyres
//             </p>
//           </div>
        ...
        {loading ? (
          ...
          <div className="p-4">
            <Swiper
              ...
              spaceBetween={18}
              slidesPerView={2}
              className="!pb-4" // Ensures slider navigation/shadows don't get clipped
              breakpoints={{
                480: { slidesPerView: 2 },
                640: { slidesPerView: 3 },
                768: { slidesPerView: 3 },
            ...
            >
              {products.map((product) => {
                ...
                return (
                  <SwiperSlide
                    key={product._id}
                    className="!h-auto" // Forces Swiper containers to match heights natively
                  >
                    {/* CARD CONTAINER */}
                    <div className="flex flex-col h-full bg-white rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-300 group border border-gray-100">
                      ...
                      <div className="p-4 flex flex-col flex-grow justify-between gap-2">
                        ...
                        <div>
                          ...
                          <Link to={`/product/${slug}`}>
                            {/* Sets a safe minimum height so 1-line and 2-line titles span equal space */}
                        ...
                        {/* BOTTOM HALF: Financials and Stock Metrics */}
                        <div className="mt-auto space-y-2">
                          ...
                          <div>
                            ...
                            {product?.salePrice ? (
                              ...
                              // Blank structural placeholder preserves uniform card alignment
                              <div className="h-4" />
                            )}
                          </div>
            ...
            {products.length === 0 && (
              <div className="text-center py-16">
                ...
                <p className="text-gray-500 mt-3">
                  Automotive products will appear here.
                </p>
              </div>
            )}
          </div>
