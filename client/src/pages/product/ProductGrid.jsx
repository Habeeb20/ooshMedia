            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 items-stretch">
              {products.map((product) => {
                ...
                return (
                  <div
                    key={product._id}
                    className="bg-white rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-300 group border border-gray-100 flex flex-col h-full"
                  >
                    {/* IMAGE */}
                    <Link to={`/product/${slug}`}>
                      <div className="relative overflow-hidden">
                        <img
                          ...
                          alt={product?.name}
                          className="h-44 md:h-56 w-full object-cover group-hover:scale-105 transition duration-500"
                        />
                    ...
                    <div className="p-4 flex flex-col flex-1 justify-between gap-2">
                      ...
                      <div>
                        ...
                        {/* PRODUCT NAME */}
                        <Link to={`/product/${slug}`}>
                          <h3 className="font-semibold text-sm md:text-base mt-0.5 text-gray-800 line-clamp-1 hover:text-[#8B1E3F] transition">
                            {product?.name}
                          </h3>
                        </Link>
                      ...
                      {/* BOTTOM SECTION: Pricing and Stock Metrics */}
