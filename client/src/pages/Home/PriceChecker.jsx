...
//       <div className="p-3 flex flex-col flex-1">
//         {/* Fixed-height name: always exactly 2 lines, truncated with ellipsis if longer */}
//         <h4 className="text-sm font-medium text-gray-800 line-clamp-2 h-10 leading-5">
//           {product.name}
//         </h4>

//         {/* Fixed-height category: always 1 line, truncated if longer */}
//         <p className="text-xs text-gray-400 mt-0.5 truncate h-4">
//           {product.category}
//         </p>
...
//         <p className="mt-auto pt-2 text-xs font-medium text-emerald-600 text-left truncate">
//           {product.seller?.businessProfile?.businessName || product.seller?.username} →
//         </p>
//       </div>
//     </button>
