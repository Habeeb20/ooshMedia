...
//   // Covers both /dashboard and /dashboard?tab=... — query strings live in
//   // location.search, so checking pathname alone is enough for either case.
//   const isDashboardRoute = location.pathname.startsWith('/dashboard');

//   // The dashboard has its own layout/navigation entirely — render nothing
//   // here at all on dashboard routes: no top nav, no bottom nav, no drawers.
