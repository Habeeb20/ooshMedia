      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow p-6 mb-12">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2">
              <button onClick={() => setSearchType('seller')} className={`px-6 py-3.5 rounded-2xl font-medium transition-all ${searchType === 'seller' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>
                Seller
              </button>
              <button onClick={() => setSearchType('product')} className={`px-6 py-3.5 rounded-2xl font-medium transition-all ${searchType === 'product' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}>
                Product
              </button>
            </div>

            <button onClick={fetchDistributionChain} disabled={loading || !searchQuery.trim()} className="px-8 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-2xl transition-all disabled:opacity-60">
              {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : 'Search'}
            </button>
          </div>
        </div>
        ...
        {loading && <div className="flex justify-center py-20"><Loader2 className="w-10 h-10 animate-spin text-blue-600" /></div>}
  ...
  <div className="mt-16">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <ChainTree 
                      ...
                      icon={<ArrowLeft className="text-red-500" />} 
