...
//               <span className="font-medium text-gray-900 text-right max-w-[55%]">{order.seller?.firstName} {order.seller?.lastName}</span>
//             </div>
//             <div className="flex justify-between">
//               <span className="text-gray-500">Seller Phone number</span>
//               <span className="font-medium text-gray-900 text-right max-w-[55%]">{order.seller?.phoneNumber || order.seller?.alternateContact}</span>
//             </div>
//             {/* <div className="flex justify-between">
//               <span className="text-gray-500">Seller Address</span>
//               <span className="font-medium text-gray-900 text-right max-w-[55%]">{order.seller?.address} {order.seller?.lga} {order.seller?.state}</span>
//             </div> */}
//             <div className="flex justify-between">
...
import { Loader2, Package, Copy, Check, ArrowLeft, ChevronRight, Truck } from 'lucide-react';
import DeliveryTrackingMap from '../DeliverytrackingMap';
import { useSocket } from '../../config/UsesSocket';
          ...
          {orders.length === 0 ? (
            ...
            <div className="space-y-3">
              {orders.map((o) => (
                <div
                  key={o._id}
                  className="w-full bg-white rounded-2xl border border-gray-100 p-4 flex flex-col gap-3"
                >
                  <button
                    onClick={() => setSelectedOrderId(o._id)}
                  ...
                  <button
                    onClick={() => goToTrackOrder(o._id)}
                    className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-rose-50 text-rose-900 text-sm font-semibold active:scale-[0.99] transition-transform"
                  >
                    <Truck size={16} />
                    Track Order
                  </button>
