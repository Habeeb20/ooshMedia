...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="fixed left-0 right-0 z-50 bg-white/95 backdrop-blur-lg border-b border-gray-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-20">
            ...
            {/* Desktop Right Side — single "My Account" button */}
          ...
          {/* Mobile secondary row — Businesses / Price Checker / Distribution chain */}
...
//   // Measure real nav height so the spacer below is accurate — recheck when dashboard-mode
//   // toggles, since the nav is shorter (no links/mobile row) in that state
//   useEffect(() => {
...
//   return (
//     <>
//       <nav ref={navRef} className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-lg border-b border-gray-100 shadow-sm">
//         <div className="max-w-7xl mx-auto px-6">
//           <div className="flex items-center justify-between h-20">
//             {/* Logo */}
//             <Link to="/" className="flex items-center gap-3">
...
//                     {isDashboardRoute ? 'ESTORES' : 'BUSINESS MEDIA'}
//                   </p>
//                 </div>
//               </div>
//             </Link>

//             {/* Everything except logo — hidden entirely in dashboard mode */}
//             {!isDashboardRoute && (
//               <>
//                 {/* Desktop Navigation Links */}
//                 <div className="hidden md:flex items-center gap-2">
...
//                     Marketplace
//                   </Link>
//                   <Link to="/chain" className={navLinkClass('/chain')}>
//                     Distribution chain
//                   </Link>
//                   <Link to="/price-checker" className={navLinkClass('/price-checker')}>
//                     Price Checker
//                   </Link>
//                   {isAuthenticated && (
...
//                   <button
//                     onClick={() => setAccountMenuOpen((o) => !o)}
//                     className="flex items-center gap-2 px-6 py-2.5 font-semibold rounded-full border transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5"
//                     style={{ backgroundColor: 'transparent', color: '#374151', borderColor: primary }}
//                   >
//                     <User size={18} />
//                     My Account
//                     <ChevronDown
...
//                   {accountMenuOpen && (
//                     <div className="absolute top-full right-0 mt-2 w-56 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden py-2 z-[100]">
//                       {isAuthenticated ? (
//                         <>
//                           <Link
//                             to="/dashboard"
...
//           {/* Mobile secondary row — hidden entirely in dashboard mode */}
//           {!isDashboardRoute && (
//             <div className="md:hidden flex items-center justify-center gap-4 pb-3 -mt-1 text-sm overflow-x-auto">
//               {isAuthenticated && (
//                 <Link
...
//       {/* Spacer — reserves exactly the nav's real height, recalculated per route */}
//       <div style={{ height: navHeight }} />

//       {/* Mobile bottom app-style nav bar — hidden in dashboard mode */}
//       {!isDashboardRoute && (
//         <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-100 shadow-[0_-2px_10px_rgba(0,0,0,0.06)]">
//           <div className="grid grid-cols-5">
//             <Link
